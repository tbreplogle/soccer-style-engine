...
def _fixture_to_slate_row(
    ...
    return CurrentInternationalSlateRow(
        ...
        dedupe_time_comparison="",
        dedupe_time_delta_minutes=0.0,
        dedupe_time_normalization_status="",
        source_priority_score=0.0,
        source_priority_reason="",
        kickoff_time_raw=fixture.kickoff_time,
        kickoff_time_normalized="",
        kickoff_datetime_normalized="",
        kickoff_timezone_status="",
        kickoff_parse_warning="",
...
def project_current_international(
    ...
    for _, matchup in slate.iterrows():
        ...
        row.update({
            ...
            "dedupe_match_key": matchup.get("dedupe_match_key", ""),
            ...
            "dedupe_time_comparison": matchup.get("dedupe_time_comparison", ""),
            "dedupe_time_delta_minutes": matchup.get("dedupe_time_delta_minutes", ""),
            "kickoff_time_normalized": matchup.get("kickoff_time_normalized", ""),
            "kickoff_timezone_status": matchup.get("kickoff_timezone_status", ""),
