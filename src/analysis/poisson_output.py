...
def build_poisson_board_for_match(
    *,
    ...
    match_summary = pd.DataFrame([{
        ...
        "home_clean_sheet_probability": home_clean,
        "away_clean_sheet_probability": away_clean,
        "fixture_date": meta.get("fixture_date", ""),
        "kickoff_time": meta.get("kickoff_time", ""),
        "fixture_temporal_status": meta.get("fixture_temporal_status", ""),
        ...
        "fixture_key": meta.get("fixture_key", ""),
        "dedupe_match_key": meta.get("dedupe_match_key", ""),
        ...
        "dedupe_time_comparison": meta.get("dedupe_time_comparison", ""),
        "dedupe_time_delta_minutes": meta.get("dedupe_time_delta_minutes", ""),
        "kickoff_time_normalized": meta.get("kickoff_time_normalized", ""),
        "kickoff_timezone_status": meta.get("kickoff_timezone_status", ""),
    ...
    for _, row in rows.iterrows():
        ...
        board = build_poisson_board_for_match(
            ...
            metadata={
                ...
                "fixture_date": row.get("fixture_date", row.get("match_date", "")),
                "kickoff_time": row.get("kickoff_time", ""),
                "fixture_temporal_status": row.get("fixture_temporal_status", ""),
                ...
                "dedupe_match_key": row.get("dedupe_match_key", ""),
                ...
                "dedupe_time_comparison": row.get("dedupe_time_comparison", ""),
                "dedupe_time_delta_minutes": row.get("dedupe_time_delta_minutes", ""),
                "kickoff_time_normalized": row.get("kickoff_time_normalized", ""),
                "kickoff_timezone_status": row.get("kickoff_timezone_status", ""),
